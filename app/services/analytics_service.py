    ...
    async def get_overview():
        ...
        try:
            ...
            if not monthly_trends:
                monthly_trends = [{"month": datetime.utcnow().strftime("%b"), "events": 0, "registrations": 0}]
            ...
            import logging
            logging.error(f"Error in analytics overview: {e}")
            return {
                "totalEvents": 0, "activeEvents": 0, "completedEvents": 0,
                "totalRegistrations": 0, "totalUsers": 0, "totalCheckedIn": 0,
                "pendingAttendees": 0, "trendingCategory": "None",
                "categoryDistribution": {}, "recentRegistrations": [],
                "monthlyTrends": []
            }
